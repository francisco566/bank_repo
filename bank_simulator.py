...
def make_account():
    ...
    cursor.execute("INSERT INTO Bank_accounts (firstname, lastname, birthday, password, balance) VALUES (%s,%s,%s,%s,%s)", (first_name, last_name, birth_date, password, starting_balance))
